...
/**
 * This <code>DecimalMax</code> is used to validate validate max number value.
 * 
 * @author ROBERTO RANZ
 */
public class DecimalMaxValidator extends AbstractValidator<Double> {
	 ...
	 * @param value
	 */
	public DecimalMaxValidator(String errorMessage, Double value) {
		super(errorMessage);
		this.value = value;
	}
	 ...
	 * @param value
	 */
	public DecimalMaxValidator(Double value) {
		this.value = value;
	}
	 ...
	 * @param annotation
	 */
	public DecimalMaxValidator(String errorMessage, Annotation annotation) {
	...
	public Key getKeyErrorMessage() {
		return LocaleValidators.DECIMALMAX;
	}
