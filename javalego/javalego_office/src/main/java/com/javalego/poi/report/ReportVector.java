...
import com.javalego.poi.report.elements.calcfields.ReportCalcFieldVector;
...
public class ReportVector extends BasicReport {
	...
	public static void main(String[] args) {
		...
		report.setFileName("c:/temp/listado.xlsx");
		...
		if (fieldName != null && index > -1)
			if (dataObject instanceof List)
				...
				try {
					...
					throw new Exception("El campo '" + fieldName + "' no se encuentra en la lista definida en el informe. Revisad informe y si el número de campos definidos coincide con la lista de valores.", e);
				}
			}
		else
		  return null;
