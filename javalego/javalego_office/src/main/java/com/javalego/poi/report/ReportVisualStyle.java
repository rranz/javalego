...
public class ReportVisualStyle {
	...
	private ExcelWorkbookXSSF excel;
	...
	public ReportVisualStyle(ExcelWorkbookXSSF excel){
		this.excel = excel;
	}
	 ...
	 * @param cell
	 */
	public void setApplyStyle(Cell cell){

		if (style == null) {
			style = excel.createStyle();
		}
		
		setApplyStyle(cell, this.style);
	}
	 ...
	 * @param cell
	 */
	public void setApplyStyle(Cell cell, CellStyle style){
		...
		// Format
		if (format != null) {
			DataFormat dataFormat = excel.getWorkBook().createDataFormat();
...
//	public boolean isCombineCells() {
//		return combineCells;
//	}
//
//	public void setCombineCells(boolean combineCells) {
