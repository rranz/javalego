...
/**
 * Evaluador de expresiones basado en los elementos de un documento de Word que utiliza
 * bookmarks y campos de formulario como campos de información del documento.
 * @author ROBERTO RANZ
 */
public class WordDocumentExpression {

	/**
	 * Token que representa un Bookmark y obtiene el valor del objeto que lo representa (propiedad o índice de un array de valores).
	 */
	...
	/**
	 * Formato aplicado al valor recuperado dependiendo del tipo de valor (fecha, etc.).
	 */
