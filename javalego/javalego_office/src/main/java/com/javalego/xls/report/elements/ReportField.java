...
public class ReportField extends ReportCustomField implements IReportItem {
	...
	public void generate() throws Exception {
		...
		if (styleCell.getFontName() == null) {
			styleCell.setFontName(report.getFontNameDefault());
		}
		...
		// Personalizar las características de impresión de una celda.
		if (report.getCustomReport() != null) {
			report.getCustomReport().changeStyleCell(styleCell, report.getActualObject(), fieldName, value);
		}
	...
	public void setAlignmentCenter(){
		getStyleCell().setAlignment(HSSFCellStyle.ALIGN_CENTER);
	}
	...
	public void setAlignmentLeft(){
		getStyleCell().setAlignment(HSSFCellStyle.ALIGN_LEFT);
	}
	/**
	 * Alinear el contenido de campo a la derecha de la celda.
	 */
	public void setAlignmentRigth(){
		getStyleCell().setAlignment(HSSFCellStyle.ALIGN_RIGHT);
	}
