...
public class Property extends BasicElement {
	...
	/**
	 * Valor de la propiedad que podemos definir para no recuperarla del objeto. 
	 * Esta propiedad es útil si necesitamos formatear dicha información cuando se trata de propiedades de un objeto especiales. Ej.: CalendarProperty
	 * del framework de Gana donde la clase ObjectDocument establece este valor formateado, evitando mostrar el texto en formato xml.
	 */
