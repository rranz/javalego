 ...
 * <p>
 * Ofrece métodos de utilidad globales a la aplicación que simplifican el desarrollo.
 * </p>
 * <p>
 * Ej.: obtener la traducción de un texto utilizando el valor locale de la sesión de usuario.
 * </p>
 * 
 * @author roberto
 * 
...
public class UIContext implements Context
{
	...
	/**
	 * Obtiene una excepción cuyo texto se obtiene de un enumerado (Key) que define dicho texto en varios idiomas.
	 * 
	 * @param exception
	 *            Excepción
	 * @param key
	 ...
	 * @param params
	 *            Lista de parámetros a incluir en el texto (Ej.: Campo {0} y campo {1} sin valor).
	 * @return
	 */
	...
	/**
	 * Obtiene la traducción de un enumerado que incluye anotaciones para obtener este texto en varios idiomas. Obtiene
	 * su valor del atributo value de la enumeración Locale.
	 * 
	 * @param value
	 * @return
	 */
	...
	/**
	 * Obtiene la traducción de un enumerado que incluye anotaciones para obtener este texto en varios idiomas. Obtiene
	 * su valor del atributo description de la enumeración Locale.
	 * 
	 * @param value
	 * @return
	 */
	...
	/**
	 * Obtiene la traducción del título de un objeto BaseModel utilizando el valor locale de la sesión de usuario.
	 * 
	 * @param value
	 * @return
	 */
	...
	/**
	 * Obtiene la traducción de la descripción de un objeto BaseModel utilizando el valor locale de la sesión de
	 * usuario.
	 * 
	 * @param value
	 * @return
	...
	public static Locale getUserSessionLocale()
	{
		...
		return hasUserSession() ? SecurityContext.getCurrent().getUserSession().getLocale()
			: (LocaleContext.getCurrent() != null ? LocaleContext.getDefaultLocale() : Locale.getDefault());
	}
	...
	/**
	 * Obtener el código del país de la sesión de usuario o del sistema operativo.
	 * 
	 * @return
	 */
	...
	/**
	 * Comprueba si existe un servicios de obtención de datos de la sesión de usuario.
	 * 
	 * @return
	 */
	...
	/**
	 * Establecer el país por defecto para la aplicación. En entornos como Android se obtiene de los recursos Ej.:
	...
	/**
	 * Logout del usuario en la aplicación. 1. Realiza el logout de la seguridad activa de la aplicación
	 * {@link SecurityContext} 2. Recarga la aplicación para volver a solicitar la página de inicio.
	 */
	...
	/**
	 * Obtener el componente UI a partir de la clave de un icono registrado en los repositorios de imágenes.
	 * 
	 * @param icon
	 * @return
