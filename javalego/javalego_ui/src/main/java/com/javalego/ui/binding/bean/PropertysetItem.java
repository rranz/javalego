...
public class PropertysetItem implements Item, Item.PropertySetChangeNotifier, Cloneable {
	...
	public int hashCode() {
		...
		return (list == null ? 0 : list.hashCode()) ^ (map == null ? 0 : map.hashCode())
				^ ((propertySetChangeListeners == null || propertySetChangeListeners.isEmpty()) ? 0 : propertySetChangeListeners.hashCode());
	}
}
