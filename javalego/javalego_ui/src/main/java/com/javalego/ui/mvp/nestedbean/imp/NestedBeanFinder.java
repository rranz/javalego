 ...
 * un bean que utilizando un buscador personalizado a las necesidades de la aplicación.
 * 
 ...
 * <p>
 * 1. Ejecutar el tipo de buscador implementado
 * <p>
 * 2. Validar el valor devuelto por el buscado y actualizar los valores del bean nested en función de si
 * existe o no dicho valor, en especial el campo ID para beans derivados de
 * IEntity.
 * 
 * TODO No utilizado todavía hasta implementar las interfaces de tipos de buscadores válidos para ser implementados (Ej.: grids de búsqueda y selección como en Vaadin).
 * 
 * @author ROBERTO RANZ
 * 
 * @param <T>
 ...
 * 
 */
public abstract class NestedBeanFinder<T, U> implements INestedBeanServices<T, U> {
