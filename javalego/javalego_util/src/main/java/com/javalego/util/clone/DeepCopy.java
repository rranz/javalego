package com.javalego.util.clone;
 ...
 * exception.
 * 
 * Ver. help.technical.JavaTechniques_Faster Deep Copy of Java Objects.pdf
 */
public class DeepCopy {
	 ...
	 * Returns a copy of the object, or null if the object cannot be serialized.
	 */
	public static Object copy(byte[] stream) {
		Object obj = null;
		try {
			// Retrieve an input stream from the byte array and read
			// a copy of the object back in.
	 ...
	 * Returns a copy of the object, or null if the object cannot be serialized.
	 */
	public static byte[] getStream(Object orig) {
		try {
			// Write the object out to a byte array
			FastByteArrayOutputStream fbos = new FastByteArrayOutputStream();
			ObjectOutputStream out = new ObjectOutputStream(fbos);
	 ...
	 * Returns a copy of the object, or null if the object cannot be serialized.
	 */
	public static byte[] getStream(Object orig, int initSize) {
		try {
			// Write the object out to a byte array
			FastByteArrayOutputStream fbos = new FastByteArrayOutputStream(initSize);
			ObjectOutputStream out = new ObjectOutputStream(fbos);
			out.writeObject(orig);
			out.flush();
			out.close();
