...
/**
 * Clase para convertir un documento Csv a Xml.
 * @author ROBERTO RANZ
 */
public class CsvToXml {
	...
	public static void main(String[] args)
	{
		...
		try	{
			CsvToXml csvConverter = new CsvToXml();
			String fileCsv = "d:\\markit.csv"; 
			String fileXml = "d:\\markit3.xml";
			int rowsCount = csvConverter.convertFile(fileCsv, fileXml);
			if(rowsCount >= 0)
			{
